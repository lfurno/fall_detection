...
# When False, all keypoints are drawn in green lime.
# When True, keypoints are drawn in different colors to identify
# them more easily. Please, see below the KEYPOINT_NAMES and
# COLORS lists for the mapping.
DEBUG = False
    ...
    for cls in classes:
        ...
        for seq in sequences:
            ...
            for frame_path in tqdm(frames, total=len(frames), desc=str(seq)):
                ...
                # Shape: The output tensor output_model[0] is shaped as
                # (batch_size, number of candidate detections, features of each detection).
                # The features of each detection is organized as follows
                # [ x_center, y_center, width, height, conf_value, class_id, kp0...kp16]
